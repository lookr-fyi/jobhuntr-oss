...
test("full restore accepts only bounded JobHuntr backup keys", async () => {
      ...
      jobs: [
        {
          ...
          salary_range: [150000, 210000],
          job_type: "Full-time",
          remote_type: "Hybrid",
          senior_level: "Staff",
          eoy: 5,
          provide_visa_sponsorship: true,
          application_datetime: "2025-01-03T04:05:06.000Z",
          ats_score: 81,
          optimized_ats_score: 94,
          ats_keyword_to_add_to_resume: ["distributed systems", "reliability"],
          questions_and_answers: [
            {
              question_text: "Are you authorized to work in the UK?",
              answer: "Yes",
  ...
  assert.deepEqual(authenticV2Job, {
    ...
    atsKeywords: ["distributed systems", "reliability"],
    numApplicants: 42,
    ...
    applicationQuestions: [
      {
        id: "legacy-application-question-v2-application-history-id-1",
      ...
      {
        id: "legacy-application-question-v2-application-history-id-2",
        question: "When could you start?",
        answer: "After two weeks",
        questionType: "text",
        options: [],
