...
| Desktop distributables                               | Electron Builder produces native macOS, Windows, and Linux packages. CI builds and retains one unsigned package artifact per platform; release signing remains certificate-dependent.                                                                                             | Proven |
